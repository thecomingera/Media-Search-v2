...
<b>Here Is The Help For My Commands.</b>"""
    ...
    ABOUT_TXT = """<b>➥ My name: {}
➥ Owner: <a href='https://t.me/riturajps'>Owner</a>
➥ Main Channel: <a href='https://t.me/piratedcitypc'>Join Channel</a>
➥ Movie Group: <a href='https://t.me/piratedcitygroup'>Join Group</a>"""

    SOURCE_TXT = """<b>Source:</b>
IMDb is a Open source project.
Source: <a href='riturajps.eu.org'>Website - Click here 👈</a>

<b>OWNER:</b>
- <a href='https://t.me/riturajps'>Owner</a>

<b>Request Channel</b>
- <a href='https://t.me/piratedcity'>Movies Request Channel</a>"""
...
<b>NOTE:</b>
1. PiratedCity should have admin privillage.
...
- PiratedCity support both url and alert inline buttons.

<b>NOTE:</b>
1. Telegram will not allows you to send buttons without any content, so content is mandatory.
2. PiratedCity supports buttons with any telegram media type.
3. Buttons should be properly parsed as markdown format.

<b>URL buttons:</b>
<code>[Button Text](buttonurl:piratedcitypc)</code>
...
<b>NOTE:</b>
• PiratedCity should have admin privillage.
...
• PiratedCity should have admin privillage.
• These commands works on both pm and group.
• PiratedCity can translate texts to 200+ languages."""
...
<b>Example:</b>
<code>/short https://t.me/riturajps</code>
...
<b>Example:</b> <code>/ytthumb https://youtu.be/abcd123156</code>
